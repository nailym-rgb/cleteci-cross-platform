          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ...
                const Divider(height: 100),
                Text('Can check biometrics: ${appState.canCheckBiometrics}\n'),
                ElevatedButton(
                  onPressed:
                      appState.supportState == LocalAuthSupportState.supported
                      ? appState.checkBiometrics
                      : null,
                  child: const Text('Check biometrics'),
                ),
                const Divider(height: 100),
                Text('Available biometrics: ${appState.availableBiometrics}\n'),
                ElevatedButton(
                  onPressed:
                      appState.supportState == LocalAuthSupportState.supported
